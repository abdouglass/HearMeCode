...
movie_title = ["A Philadelphia Story", "Bringing Up Baby", "His Girl Friday", "Adam's Rib", "Arsenic and Old Lace"]
parent_rating = ["NR","G","NR","Passed", "NR"]
bechdel_rating = [3,3,3,3,3]
IMDB_rating = [8.1,8.1,8.1,7.6,8.1]
genre = ["Comedy/Romance", "Comedy/Romance","Comedy/Drama/Romance","Comedy/Drama/Romance","Comedy/Crime"]

for movie, parent, bedchel, IMDB, gen in zip(movie_title,parent_rating,bechdel_rating,IMDB_rating,genre):
    print "{0}, {1}, {2}, {3}, {4}".format(movie,parent,bedchel,IMDB,gen)
